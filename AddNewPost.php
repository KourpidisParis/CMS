...
if(isset($_POST["Submit"])){
    ...
    if(empty($PostTitle)){
      ...
      //Query to insert post in DB when everythin is fine
      ...
      if($Execute){
        $_SESSION["SuccessMessage"]= "Post with id:".$ConnectionDB->lastInsertId()."added Successfully";
        Redirect_to("AddNewPost.php");
      }else{
            ...
            <form class="" action="AddNewPost.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body text-white">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="PostTitle" id="title" value="" placeholder="Type here the title">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="PostDecription" id="Post" cols="80" rows=8\s></textarea>
